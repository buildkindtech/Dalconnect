    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[500px] flex items-center justify-center">
        ...
        <div className="relative z-20 container mx-auto px-4 text-center text-white">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 font-ko tracking-tight">
            Discover DFW's Best <br/><span className="text-primary">Korean Businesses</span>
          </h1>
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto text-slate-200">
            Your trusted guide to authentic restaurants, reliable services, and local news in the Dallas-Fort Worth Korean community.
          </p>
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-full p-2 flex shadow-xl">
            ...
            <div className="hidden md:flex flex-1 items-center px-4 text-slate-800">
              ...
              <Input 
                className="border-0 shadow-none focus-visible:ring-0 text-base h-12" 
                placeholder="Carrollton, Dallas..." 
                defaultValue="Carrollton, TX"
              />
            </div>
            <Button size="lg" className="rounded-full px-8 h-12 text-base">Search</Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 font-ko">Browse Categories</h2>
            <p className="text-muted-foreground">Find exactly what you need in our community</p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-10">
            <div>
              <h2 className="text-3xl font-bold mb-2 font-ko">Featured Businesses</h2>
              <p className="text-muted-foreground">Highly rated and community trusted</p>
            </div>
            <Link href="/listings">
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-10">
            <div>
              <h2 className="text-3xl font-bold mb-2 font-ko">Community News</h2>
              <p className="text-muted-foreground">Stay updated with DFW Korean community happenings</p>
            </div>
            <Link href="/news">
      ...
      <section className="py-24 bg-primary text-white text-center">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 font-ko">Own a business in DFW?</h2>
          <p className="text-lg md:text-xl text-primary-foreground/90 mb-8">
            Join thousands of local Korean-American businesses and reach a highly targeted community audience.
          </p>
