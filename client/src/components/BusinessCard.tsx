...
export default function BusinessCard({ business }: BusinessCardProps) {
  ...
  const isSponsored = business.tier === "basic" || business.tier === "premium";
      ...
      <CardContent className="p-0">
        <Link href={`/business/${business.id}`}>
          ...
          <div className="relative overflow-hidden">
            ...
            {isSponsored && (
              <span className="absolute top-2 left-2 rounded bg-amber-400 px-2 py-0.5 text-[10px] font-bold text-black">
                광고
              </span>
            )}
          </div>
